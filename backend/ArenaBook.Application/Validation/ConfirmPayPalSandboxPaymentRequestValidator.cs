...
public sealed class ConfirmPayPalSandboxPaymentRequestValidator
    : AbstractValidator<ConfirmPayPalSandboxPaymentRequest>
{
    public ConfirmPayPalSandboxPaymentRequestValidator()
    {
